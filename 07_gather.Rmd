...
with $\beta_1 < \beta_2$. No $\beta_3$ is needed, since $\pi_{3, i, j}$ can be calculated from the response probabilities of the other two categories.
...
pars_tab %>% 
  kable(
    escape = FALSE,
     caption = "Summary of posterior distributions for additional model parameters.",
    booktabs = TRUE,
    linesep = "",
    col.names =
