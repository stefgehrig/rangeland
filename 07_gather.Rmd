...
(i) There could be unobserved  (e.g., geographical, social, cultural, economic) factors which affect both quality of governance and of outcomes (*confounding bias*).
(ii) We have only observed the relationship for the subset of villages which was non-randomly selected into the Northern Tanzania Rangelands Initiative (NTRI) project and, later, into the project assessment. Both quality of governance and outcomes could (directly or indirectly) affect the probability of being included in the assessment (*selection bias*).
...
```{r dagbig, fig.align='center', fig.cap='DAG to illustrate the potential confounding and selection bias affecting estimates of the effect of governance quality on governance outcomes. Circles indicate unobserved variables, square boxes indicate conditioned-on variables due to study design. The color indicates the two variables whose association we analyze.', out.width="90%"}
