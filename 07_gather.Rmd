...
A natural way to visualize the data in Table \ref{tab:dfsum} is via spider plots (Figure \ref{fig:spider}), for Table \ref{tab:dfsum} it is via stripe and box plots (Figure \ref{fig:box}).

- table 1: tier3, tier1, description/direction, distirbution 1, 2, 3. caption: binary coded as 1-3, middle optino always missing
